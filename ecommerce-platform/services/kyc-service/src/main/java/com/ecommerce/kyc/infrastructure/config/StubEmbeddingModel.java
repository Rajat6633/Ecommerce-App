 ...
 * (or near-identical) names embed to near-identical vectors — enough for the
 * pgvector / in-memory store to exercise similarity logic without downloading
 * the Transformers ONNX model or calling any external API.
 *
 * <p>Spring AI 1.0.0-M1 represents embeddings as {@code List<Double>}.
 */
