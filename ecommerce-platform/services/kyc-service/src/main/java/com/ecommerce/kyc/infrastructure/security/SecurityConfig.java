package com.ecommerce.kyc.infrastructure.security;
...
/**
 * Resource-server security (RS256). Officer endpoints require ROLE_COMPLIANCE
 * (enforced via method security on the controller); the self-status read
 * requires the owning user. Actuator/docs are public.
 */
@Configuration
