...
/**
 * Resource-server security. Catalog reads are public; writes require a valid
 * RS256 JWT (issued by auth-service) carrying the ADMIN role. The public key
 * is loaded from {@code auth.jwt.public-key-location}.
 */
@Configuration
